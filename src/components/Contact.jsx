const socialLinks = [
  ...
  {
    href: "https://www.linkedin.com/in/pranjeetgoswami/",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  return (
    <section className="section" id="contact">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form action="https://getform.io/f/awnnleeb" method="POST" className="xl:pl-10 2xl:pl-20">
            <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                <div className="mb-4">
                    <label htmlFor="" className="label reveal-up">Name</label>
                    <input type="text" className="text-field reveal-up" name="name" id="name" autoComplete="name" required placeholder="Enter your name"/>
                </div>
                <div className="mb-4">
                    <label htmlFor="" className="label">Email</label>
                    <input type="email" className="text-field" name="email" id="email" autoComplete="email" required placeholder="Enter your Email"/>
                </div>
            </div>
            ...
            <button type="submit" className="btn btn-p [&]:max-w-full w-full justify-center reveal-up">Submit</button>
        </form>
      </div>
    </section>
  );
